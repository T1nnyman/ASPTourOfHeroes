...
namespace TourOfHeroes.Services
{
    public class HeroService : IHeroService
    {
        ...
        {
            Hero? hero = await _context.Heroes.FirstOrDefaultAsync(hero => hero.HeroID == id);
            if (hero == null)
            {
                return null;
            }
        ...
        public async Task<Hero> UpdateHeroAsync(Hero hero)
        {
            ...
            _messageService.Add($"HeroService: updated hero id={hero.HeroID}");
        ...
        public async Task<Hero> AddHeroAsync(Hero hero)
        {
            ...
            _messageService.Add($"HeroService: added hero w/ id={hero.HeroID}");
